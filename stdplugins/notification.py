...
BAALAJI_TG_USER_BOT = "HELLO FRIENDS
IF YOU WANT TO SALE YOU ARE ID SEND VIDEO OR SS AND WITH PRICE,"
TG_COMPANION_USER_BOT = "And if you want to buy ID go to our official store @FOGStore.
AND IF YOU WANT TO BUY HACKS ROOT AND NON ROOT AVAILABLE, PRICE OF ROOT HACK =2500rs,
PRICE OF NON ROOT HACK =3000RS, AND PLEASE 🥺 FOLLOW ME ON INSTAGRAM https://www.instagram.com/maxh2x?r=nametag.
UNIBORG_USER_BOT_WARN_ZERO = "I AM OFFLINE I WILL ANSWER YOUR QUESTION WHEN I WILL ONLINE"
